...
public class Configuration extends HttpServlet implements PluginData {
    ...
    @Inject
    public Configuration(UserManager userManager, ActiveObjects ao, LoginUriProvider loginUriProvider, TemplateRenderer renderer, SpaceManager spaceManager, GroupManager groupManager, PluginSettingsFactory pluginSettingsFactory) {
