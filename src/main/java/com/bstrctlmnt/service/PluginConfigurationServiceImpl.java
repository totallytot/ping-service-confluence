...
public class PluginConfigurationServiceImpl implements PluginConfigurationService{
    ...
    public boolean updateConfigurationFromJSON(JsonDataObject jsonDataObject) {
        ...
        List<String> labelsToAdd = jsonDataObject.getLabelsToAdd();
        List<String> labelsToDel = jsonDataObject.getLabelsToDel();
        ...
        if (labelsToAdd != null && labelsToAdd.size() > 0) labelsToAdd.forEach(pluginDataService::addLabel);
        if (labelsToDel != null && labelsToDel.size() > 0) labelsToDel.forEach(pluginDataService::removeLabel);
    ...
    public Map<String, Object> getConfiguration() {
        ...
        configData.put("ignoredLabels", pluginDataService.getLabels());
